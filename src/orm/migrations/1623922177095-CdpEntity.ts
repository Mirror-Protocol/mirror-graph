...
export class CdpEntity1623922177095 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "cdp" ADD "collateral_value" numeric(40) NOT NULL DEFAULT '0'`
    )
    await queryRunner.query(
      `ALTER TABLE "cdp" ADD "min_collateral_ratio" numeric(40,6) NOT NULL DEFAULT '2'`
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_3594abc1463386d49b4bab74da" ON "cdp" ("collateral_ratio") `
    )
    await queryRunner.query(
      `CREATE INDEX "IDX_c49397d5f687b8b04aa9aa5d35" ON "cdp" ("min_collateral_ratio") `
    )
